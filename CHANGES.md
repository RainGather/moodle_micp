...
### Changed
- Reduced the default activity maximum grade from 100 to 10 for new MICP activities
- Updated the database field default for `micp.grade` so upgraded sites stay aligned with the form default
